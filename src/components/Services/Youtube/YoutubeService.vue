  ...
  <v-row justify="center">
    ...
    <v-col sm="12" md="8" lg="9" xl="8" justify="start">
      ...
      <v-card id="borderDemo" min-height="100vh">
        <v-card-title class="d-flex justify-center align-center mb-2"><h2>Youtube Service</h2></v-card-title>
        <v-divider></v-divider>
          <v-row>
        ...
        <v-card-text class="d-flex align-center ">
          <v-window class="d-flex justify-center align-center " v-model="tab">
            ...
            <v-window-item value="three">
              ...
              <p class="text-left">
                1) Before receiving a message about the complete fulfillment of your order and during the entire warranty period:
              </p>
              <p class="text-left">
                a. DO NOT CHANGE LOGIN (NICK = URL);
              </p>
              <p class="text-left">
                b. DO NOT CHANGE THE INFORMATION IN THE PROFILE (description, contacts, links);
              </p>
              <p>
                c. DO NOT CHANGE THE THEME OF YOUR PUBLICATIONS;
              </p>
              <p>e. DO NOT ORDER SERVICES IN OTHER SERVICES.</p>
  ...
  data() {
    return {
      ...
      images: [
        ...
        {
          src: "https://firebasestorage.googleapis.com/v0/b/socialmanager-7c8fd.appspot.com/o/Youtube%2Fyoutube3.webp?alt=media&token=3c8d0ae7-1514-4a29-82cf-a97b45b2d4c0",
        },
